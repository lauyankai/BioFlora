...
- **Limited Identification Accuracy**
    -The app relied solely on image recognition to identify species. It often faced difficulties distinguishing between visually similar species. Many animals and plants have very subtle differences that can be hard to capture accurately in photographs, and it may cuase misidentifications.
<p>  </p>
...
- **Slow and Inconvenient Identification Process**
    - Users had to take a photo and upload it for species identification. The process was slow, especially in areas with poor internet connectivity, as users had to wait for the photo to upload and be processed by the server before getting results.
<p>  </p>

<center>
<p>  </p>
<img src="/RewardSystem.png" width="200" class="rounded"/>
<sub> **Figure 3** Problem 3</sub>
<p>  </p>
</center>
- **Low User Engagement**
    -The app lacked a reward system, providing no incentives for users to stay engaged. Without rewards, users were less motivated to regularly track their health metrics or participate in community activities, leading to lower overall engagement.
<p>  </p>
