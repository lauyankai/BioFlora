...
&ensp;&ensp;&ensp;&ensp;Our system implements four out of the five Gestalt principles which are similarity, proximity, continuation, and enclosure. For the sake of demonstrating Gestalt principles, we shall just select a few interfaces.
